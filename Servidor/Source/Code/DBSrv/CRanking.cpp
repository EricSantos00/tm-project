...
{
	rankingSystem.grindRanking.Flag = true;

	for (int i = 1; i < MAX_RANK_INDEX; i++)
	{
		rankingSystem.grindRanking.m_GrindRank[i] = new STRUCT_RANKING();
	}
	...
	rankingSystem.grindRanking.Flag = false;
}
