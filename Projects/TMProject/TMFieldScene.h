...
public:
	...
	int OnPacketItemSold(MSG_STANDARD* pStd);
	int OnPacketUpdateCargoCoin(MSG_STANDARD* pStd);
	int OnPacketWeather(MSG_STANDARD* pStd);
	...
	int OnPacketRemoveItem(MSG_STANDARD* pStd);
	...
	int OnPacketSetHpMode(MSG_STANDARD* pStd);
	...
	int OnPacketSetShortSkill(MSG_STANDARD* pStd);
	...
	int OnPacketItemPrice(MSG_STANDARD* pStd);
